                ...
                <div className="card-body">
                    <Form>
                            ...
                            <Col md={4}>
                                ...
                                <div className="p-4">
                                    ...
                                    <div className="d-flex align-items-center pb-1">
                                        ...
                                        />
                                        {quotationDetails.company_info &&
                                            quotationDetails.company_info.store_email ? quotationDetails.company_info.store_email : 'N/A'}
                                    </div>
                                    <div className="d-flex align-items-center pb-1">
                                        <FontAwesomeIcon
                                            icon={faMobileAlt}
                                        ...
                                        />
                                        {quotationDetails.company_info &&
                                            quotationDetails.company_info.store_phone ? quotationDetails.company_info.store_phone : 'N/A'}
                                    </div>
                                    <div className="d-flex align-items-center">
                                        <FontAwesomeIcon
                                            icon={faLocationDot}
                            ...
                            <Col md={4}>
                                ...
                                <div className="p-4">
                                    ...
                                    <div className="pb-1">
                                        ...
                                        <span>
                                            {quotationDetails.warehouse &&
                                                quotationDetails.warehouse.name}
                                        </span>
                                    </div>
                                </div>
                            </Col>
                        ...
                        <div className="row">
                            ...
                            {quotationDetails.note && <div className="card pt-7 px-2">
                                    <label className="form-label mb-0">{getFormattedMessage("globally.input.note.label")}:</label>
                                    <p className="text-gray-600">{quotationDetails.note}</p>
                                </div>}
                            </div>
