        ...
        <MasterLayout>
            ...
            <TabTitle title={placeholderText('product.categories.title')}/>
                <ReactDataTable columns={columns} items={itemsValue} onChange={onChange} isLoading={isLoading}
                                AddButton={<CreateProductCategory/>} isCallFetchDataApi={isCallFetchDataApi}
...
const mapStateToProps = (state) => {
    const {productCategories, totalRecord, isLoading, isCallFetchDataApi} = state;
    return {productCategories, totalRecord, isLoading, isCallFetchDataApi}
};
