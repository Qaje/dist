...
import { comparePlans, createSubscription, fetchPaymentMethods, handlePaypalPayment, handleRazorPayPayment, handleStripePayment } from '../../store/action/plansAction';
import MasterLayout from '../MasterLayout';
import { useRazorpay } from "react-razorpay";

const ComparePlan = (props) => {
    const { fetchPaymentMethods, userPlans, comparePlans, createSubscription, handlePaypalPayment, handleStripePayment, handleRazorPayPayment, stores } = props;
    const { id } = useParams();
        ...
        <MasterLayout>
            ...
            <div className="card">
                <div className="card-body">
                    ...
                    {selectedPaymentMethod === PAYMENT_METHODS.MANUAL ? <p className='text-center'><span className='fw-bold'>{getFormattedMessage("payment-settings.manual-instructions.label")}:</span> <br />{userPlans?.paymentMethods?.manual_payment_guide}</p> : ''}
...
export default connect(mapStateToProps, { fetchPaymentMethods, comparePlans, createSubscription, handlePaypalPayment, handleStripePayment, handleRazorPayPayment })(ComparePlan)