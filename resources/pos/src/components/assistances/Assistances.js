...
const Assistances = ({
    ...
    const itemsValue = (asistances || []).map((assistance) => {
        ...
        return {
            ...
            created_at: getFormattedDate(assistance.created_at, allConfigData) || 'N/A'
        };
    });
...
//         },
//         {
//             name: getFormattedMessage("asistance.table.column.code"),
//             selector: (row) => row.code,
//             sortField: "code",
//             sortable: true,
//             cell: (row) => (
...
// const mapStateToProps = (state) => {
//     console.log('🗺️ mapStateToProps - Estado completo:', state);
//     console.log('🗺️ mapStateToProps - Estado de assistance:', state.assistance);
//     console.log('🗺️ mapStateToProps - Datos extraídos:', {
//         asistances: state.assistance?.data || [],
//         totalRecord: state.assistance?.meta?.total || 0,
//         isLoading: state.assistance?.loading || false,
//     });
//
//     // Verificar si el estado tiene la estructura correcta
//     if (!state.assistance) {
//         console.warn('⚠️ state.assistance no existe. Nombres de estado disponibles:', Object.keys(state));
//     }
//
//     return {
//         asistances: state.assistance?.data || [],
