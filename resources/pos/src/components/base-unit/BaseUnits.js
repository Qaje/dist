...
const BaseUnits = (props) => {
    const {fetchBaseUnits, baseUnits, totalRecord, isLoading, isCallFetchDataApi } = props;
...
const mapStateToProps = (state) => {
    const { baseUnits, totalRecord, isLoading, isCallFetchDataApi } = state;
    return { baseUnits, totalRecord, isLoading, isCallFetchDataApi }
};
