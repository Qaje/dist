...
const ExpenseCategory = (props) => {
    const { fetchExpenseCategories, expenseCategories, totalRecord, isLoading, isCallFetchDataApi } = props;
    ...
    return (
        <MasterLayout>
            ...
            <ReactDataTable columns={columns} items={itemsValue} onChange={onChange} isLoading={isLoading}
                AddButton={<CreateExpenseCategory />} isCallFetchDataApi={isCallFetchDataApi}
...
const mapStateToProps = (state) => {
    const { expenseCategories, totalRecord, isLoading, isCallFetchDataApi } = state;
    return { expenseCategories, totalRecord, isLoading, isCallFetchDataApi }
};
