                    ...
                    {loginUser?.roles != ROLES.SUPER_ADMIN ?
                        ...
                        {stores
                            ...
                            .map((store, index) => (
                                ...
                                />
                                <span className={`mb-0 ${selectedStore?.id == store.id ? 'text-primary fw-semibold' : ''}`}>{store.attributes.name}</span>
                                </Dropdown.Item>
                            ))}
                        </DropdownButton>
                        : 
                        ...
                        <div className="position-relative d-flex w-100">
                            <input
                                ...
                                placeholder={placeholderText(
                                    "dataTable.searchBar.placeholder.label"
                                )}
                                aria-label="Search"
                    ...
                    <Menu>
                        {filteredMenu.length ? (
                            filteredMenu.map((mainItems, index) => {
                                if (loginUser.roles !== ROLES.ADMIN && mainItems.name === "store") return;
                                        ...
                                        <MenuItem
                                            ...
                                            active={
                                                ...
                                                location.pathname ===
                                                    mainItems.termsPath ||
                                                location.pathname ===
                                                    mainItems.privacyPath ||
                                                location.pathname ===
                                                    mainItems.refundPath ||
                                                location.pathname ===
