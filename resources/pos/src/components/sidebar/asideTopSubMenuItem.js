...
import { faAddressCard, faAngleDown, faPlusSquare } from "@fortawesome/free-solid-svg-icons";
import { useSelector } from "react-redux";
import { Permissions, ROLES } from "../../constants";

const AsideTopSubMenuItem = (props) => {
    const { asideConfig, isMenuCollapse, isAdmin } = props;
    //console.log("AsideTopSubMenuItem props: ", state.config);
        ...
        >
            <div className="navbar-collapse">
                ...
                <div className="navbar-nav me-auto mb-2 mb-lg-0">
                    {location.pathname === "/user/profile/edit" ||
                        ...
                        <div className="nav-item position-relative mx-xl-3 mb-3 mb-xl-0">
                            <Link
                                ...
                                className={`${location.pathname === "/user/profile/edit" ||
                                    location.pathname === "/admin/profile/edit"
                                    ? "active"
                                    : ""
                                    } nav-link p-0`}
                    ...
                    ) : location.pathname.includes("/user/compare-plan") ? (
                        <div className="nav-item position-relative mx-xl-3 mb-3 mb-xl-0">
                            <Link
                                to="/user/manage-subscription"
                                className={`${location.pathname.includes(
                                ...
                                >
                                    {mainItems.items
                                        ? mainItems.items.map((item, index) => {
                                            if (index <= (window.location.hash.includes("/admin/front-cms") ? 8 : 6)) {
                                                return (
                                                    <div
                                                        key={index}
                                        ...
                                        <Dropdown className="d-flex align-items-stretch">
                                            ...
                                            <Dropdown.Menu className="mt-6">
                                                {mainItems.items &&
                                                    mainItems.items.map(
                                                        (item, index) => {
                                                            if (index >= window.location.hash.includes("/admin/front-cms") ? 9 : 7) {
                                                                return (
                                                                    <Dropdown.Item
                                                                        key={
                                                                            index
