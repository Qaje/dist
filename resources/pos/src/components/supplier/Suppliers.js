    ...
    return (
        <MasterLayout>
            ...
            <ReactDataTable columns={columns} items={itemsValue} onChange={onChange} isLoading={isLoading}
                ...
                totalRows={totalRecord} importBtnTitle={'suppliers.import.title'} isCallFetchDataApi={isCallFetchDataApi}
                to='#/user/suppliers/create' callAPIAfterImport={callAPIAfterImport}/>
