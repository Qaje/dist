...
const Brands = () => {
    const {brands, totalRecord, isLoading, isCallFetchDataApi } = useSelector(state => state);
    ...
    return (
        <MasterLayout>
            ...
            <ReactDataTable columns={columns} items={itemsValue} onChange={onChange} AddButton={<CreateBrands/>}
                            totalRows={totalRecord} isLoading={isLoading} isCallFetchDataApi={isCallFetchDataApi}/>
