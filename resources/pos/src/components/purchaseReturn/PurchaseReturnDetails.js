...
const PurchaseReturnDetails = (props) => {
    ...
    return (
        <MasterLayout>
            <TopProgressBar />
            <HeaderTitle
                title={getFormattedMessage("purchases.return.details.title")}
                to="/user/purchase-return/"
            />
            <TabTitle
                title={placeholderText("purchases.return.details.title")}
            />
            <div className="card">
                <div className="card-body">
                    <Form>
                        <div className="row">
                            <div className="col-12">
                                <h4 className="font-weight-bold text-center mb-5">
                                    {getFormattedMessage(
                                        "purchases.return.details.title"
                                    )}{" "}
                                    :{" "}
                                    {purchaseReturnDetails &&
                                        purchaseReturnDetails.reference_code}
                                </h4>
                            </div>
                        </div>
                            ...
                            <Col md={4}>
                                ...
                                <div className="p-4">
                                    <div className="d-flex align-items-center pb-1">
                                        ...
                                        />
                                        {purchaseReturnDetails.supplier &&
                                            purchaseReturnDetails.supplier.name}
                                    </div>
                                    <div className="d-flex align-items-center pb-1">
                                        <FontAwesomeIcon
                                            icon={faEnvelope}
                                ...
                                <div className="p-4">
                                    <div className="d-flex align-items-center pb-1">
                                        <FontAwesomeIcon
                                            ...
                                            className="text-primary me-2 fs-5"
                                        />
                                        {purchaseReturnDetails.company_info &&
                                            purchaseReturnDetails.company_info.store_name ? purchaseReturnDetails.company_info.store_name : 'N/A'}
                                    </div>
                                    <div className="d-flex align-items-center pb-1">
                                        <FontAwesomeIcon
                                            icon={faEnvelope}
                                        ...
                                        />
                                        {purchaseReturnDetails.company_info &&
                                            purchaseReturnDetails.company_info.store_email ? purchaseReturnDetails.company_info.store_email : 'N/A'}
                                    </div>
                                    <div className="d-flex align-items-center pb-1">
                                        <FontAwesomeIcon
                                            icon={faMobileAlt}
                                        ...
                                        />
                                        {purchaseReturnDetails.company_info &&
                                            purchaseReturnDetails.company_info.store_phone ? purchaseReturnDetails.company_info.store_phone : 'N/A'}
                                    </div>
                                    <div className="d-flex align-items-center">
                                        <FontAwesomeIcon
                                            icon={faLocationDot}
                                        ...
                                        />
                                        {purchaseReturnDetails.company_info &&
                                            purchaseReturnDetails.company_info.store_address ? purchaseReturnDetails.company_info.store_address : 'N/A'}
                                    </div>
                                </div>
                            </Col>
                            <Col md={4}>
                                ...
                                <div className="p-4">
                                    ...
                                    <div className="pb-1">
                                        ...
                                        <span>
                                            {purchaseReturnDetails.warehouse &&
                                                purchaseReturnDetails.warehouse
                                                    .name}
                                        </span>
                                    </div>
                        ...
                        <div className="row">
                            ...
                            {purchaseReturnDetails.notes && <div className="card pt-7 px-2">
                                    <label className="form-label mb-0">{getFormattedMessage("globally.input.note.label")}:</label>
                                    <p className="text-gray-600">{purchaseReturnDetails.notes}</p>
                                </div>}
                            </div>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td className="py-3">
                                                        {currencySymbolHandling(
                                                            ...
                                                            frontSetting.value &&
                                                                frontSetting
                                                                    ...
                                                                    .currency_symbol,
                                                            purchaseReturnDetails &&
                                                                purchaseReturnDetails.tax_amount >
                                                                    0
                                                                ? purchaseReturnDetails.tax_amount
                                                                : "0.00"
                                                        )}{" "}
                                                        ...
                                                        {purchaseReturnDetails &&
                                                            parseFloat(
                                                                purchaseReturnDetails.tax_rate
                                                            ).toFixed(2)}
                                                        %)
                                                    </td>
                                                </tr>
                                                        ...
                                                        {currencySymbolHandling(
                                                            ...
                                                            frontSetting.value &&
                                                                frontSetting
                                                                    ...
                                                                    .currency_symbol,
                                                            purchaseReturnDetails &&
                                                                purchaseReturnDetails.discount
                                                        )}
                                                    </td>
                                                </tr>
                                                <tr>
                                                        ...
                                                        {currencySymbolHandling(
                                                            ...
                                                            frontSetting.value &&
                                                                frontSetting
                                                                    ...
                                                                    .currency_symbol,
                                                            purchaseReturnDetails &&
                                                                purchaseReturnDetails.shipping
                                                        )}
                                                    </td>
                                                </tr>
                                                <tr>
                                                        ...
                                                        {currencySymbolHandling(
                                                            ...
                                                            frontSetting.value &&
                                                                frontSetting
                                                                    ...
                                                                    .currency_symbol,
                                                            purchaseReturnDetails &&
                                                                purchaseReturnDetails.grand_total
                                                        )}
                                                    </td>
                                                </tr>
                                            </tbody>
